            ...
            >
              ...
              <div className="flex flex-wrap gap-3">
                {category.skills.map((skill, idx) => (
                  <span 
                    key={idx}
                    className="px-3 py-1.5 sm:px-4 sm:py-2 text-xs sm:text-sm font-medium rounded-lg bg-dark-700/50 text-slate-300 border border-white/5 hover:border-primary-500/30 hover:text-white transition-colors cursor-default"
                  >
                    {skill}
                  </span>
                ))}
